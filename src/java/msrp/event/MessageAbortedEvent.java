    ...
    extends EventObject
{
     ...
     */
    public static final int RESPONSE400 = 1;
    ...
    /**
     * The reason for the Message abortion. This can come in the REPORT body and
     * is informational only as the main reason is determined by the response
     * code
     */
    ...
    /**
     * Returns the extra info that can be on the REPORT body
