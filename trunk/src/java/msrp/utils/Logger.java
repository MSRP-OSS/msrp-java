...
/**
 * Note: This is the main logging class used in Sip-Communicator, due to being
 * familiar with these methods and to the fact that it is an Open source class,
 * i decided to reuse it. Standard logging methods.
 * 
 * @author Emil Ivov
 */
public class Logger
{
     ...
     *            and should normally be based on the class name of the creator,
    ...
    public void logEntry()
    {
        if (loggerDelegate.isLoggable(Level.FINEST))
        {
            ...
            loggerDelegate.log(Level.FINEST, "[entry] "
